...
export class Earth {
    constructor() {
        ...
        // Base Earth
        const texture = loader.load(`${import.meta.env.BASE_URL}/images/earthmap1k.jpg`);
        ...
        const earthLightMat = new THREE.MeshBasicMaterial({
            map: loader.load(`${import.meta.env.BASE_URL}/images/earthlights1k.jpg`),
        ...
        const earthCloudMat = new THREE.MeshStandardMaterial({
            map: loader.load(`${import.meta.env.BASE_URL}/images/earthcloudmap.jpg`),
            transparent: true,
            opacity: 0.5,
            blending: THREE.AdditiveBlending,
        });
